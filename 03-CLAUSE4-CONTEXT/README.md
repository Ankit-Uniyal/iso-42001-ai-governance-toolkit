...
| 4 | [LEGAL-REGULATORY-REQUIREMENTS-REGISTER.md](LEGAL-REGULATORY-REQUIREMENTS-REGISTER.md) | Legal, regulatory and contractual AI obligations | 4.2 |
| 5 | [AIMS-SCOPE-STATEMENT.md](AIMS-SCOPE-STATEMENT.md) | Formal AIMS scope definition | 4.3 |
| 6 | [AIMS-PROCESS-MAP.md](AIMS-PROCESS-MAP.md) | All AIMS processes, owners & connections | 4.4 |

**Start here → CONTEXT-REGISTER.md → AI-SYSTEMS-INVENTORY.md → INTERESTED-PARTIES-REGISTER.md → LEGAL-REGULATORY-REQUIREMENTS-REGISTER.md → AIMS-SCOPE-STATEMENT.md → AIMS-PROCESS-MAP.md**
...
| 5 | Legal and Regulatory Requirements Register | 4.2 | [LEGAL-REGULATORY-REQUIREMENTS-REGISTER.md](LEGAL-REGULATORY-REQUIREMENTS-REGISTER.md) |
