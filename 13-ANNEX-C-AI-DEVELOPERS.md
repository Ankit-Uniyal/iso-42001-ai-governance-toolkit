...
## ISO/IEC 42001:2023 | Supplementary Implementation Guide

**Note:** This is a supplementary implementation guide written for organisations that build AI systems for other organisations. It is NOT a reproduction of, or a summary of, any annex of the standard. In ISO/IEC 42001:2023 the informative annexes are: **Annex B** — implementation guidance for the Annex A controls; **Annex C** — potential AI-related organisational objectives and risk sources; **Annex D** — use of the AI management system across domains or sectors. Obtain a licensed copy from ISO (iso.org) for the normative text.

---

## Purpose

This guide is for organisations that **develop AI systems for use by other organisations** — i.e., AI developers, AI product companies, AI-as-a-Service providers, and managed AI service providers. It sets out practical implementation templates for the developer-side AIMS, mapped to Annex A domain A.10 (third-party and customer relationships) and Annex A domain A.8 (information for interested parties).
...
## 1 — The AI Developer's Unique AIMS Position
...
## 2 — Developer-Specific AIMS Requirements

### 2.1 — Customer-Facing AI Documentation

AI developers must provide customers with sufficient documentation to enable them to implement and operate the AI system responsibly. This supports Annex A.10.4 (Customers) and A.8.2 (System documentation and information for users).
...
### 2.2 — Contractual Requirements for AI Developers
...
### 2.3 — Training Data Governance for Developers
...
## 3 — AI Supplier Risk Register (Developer Perspective)
...
## 4 — Developer AIMS Scope Considerations
...
2. **Which development activities are in scope?** Training, fine-tuning, testing, deployment pipelines
3. **Which customers are in scope?** Consider risk-tiering customers by the criticality of their AI use
4. **What AI sub-suppliers are in scope?** Data providers, foundational model vendors, cloud AI platforms
5. **What development environments are in scope?** Training infrastructure, CI/CD pipelines, model registries

---

## 5 — Developer-Specific Documents Checklist
...
## 6 — Regulatory Considerations for AI Developers
